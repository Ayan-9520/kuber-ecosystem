  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      if (!registeredRef.current) {
        ...
        await pushService.subscribeTopic('customer_application_updates');
      ...
      responseSub = Notifications.addNotificationResponseReceivedListener((response) => {
        ...
        if (data?.deliveryId) void pushService.trackClick(data.deliveryId, data as Record<string, unknown>);
